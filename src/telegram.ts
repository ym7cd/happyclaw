...
import { getTelegramProviderConfig } from './runtime-config.js';
import {
  storeChatMetadata,
  storeMessageDirect,
  updateChatName,
...
interface TelegramConnectOpts {
  onReady?: () => void;
  /** 收到消息后调用，让主模块自动注册未知的 Telegram 聊天到主容器 */
...
/**
 * Connect to Telegram via long polling and start receiving messages.
 */
 ...
 * Converts Markdown to Telegram HTML and splits into safe chunks.
 * @param chatId - Pure chat_id (without "telegram:" prefix)
